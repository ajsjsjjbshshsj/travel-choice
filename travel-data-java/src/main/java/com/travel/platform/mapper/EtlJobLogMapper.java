...
public interface EtlJobLogMapper {
    ...
    @Insert("""
            ...
            (job_name, job_type, job_desc, start_time, status, row_count, data_date, trigger_type)
            VALUES
            (#{jobName}, #{jobType}, #{jobDesc}, #{startTime}, #{status}, #{rowCount}, #{dataDate}, #{triggerType})
            """)
    ...
    @Select("""
            SELECT
                ...
                status, row_count, data_date, error_message, trigger_type,
